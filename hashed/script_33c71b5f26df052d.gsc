...
#include scripts/zm/zm_red_util.gsc;
#include scripts/zm/zm_red_power_quest.gsc;
#include scripts/zm/zm_red_challenges.gsc;
#include scripts/zm/zm_red.gsc;
...
function init() {
    ...
    case 0:
        ...
        if (zm_utility::is_standard()) {
            ...
            mdl_blocker = getent("pap_arena", "targetname");
            mdl_blocker delete();
            return;
        }
        break;
...
function function_90a833e2() {
    ...
    level flag::init(#"hash_63519505a67adc42");
    ...
    level flag::init(#"hash_354f85bda5493cca");
    ...
    level flag::init(#"hash_28699850caf3ead");
    level flag::init(#"pap_defend");
    level flag::init(#"hash_2643e0478beaf40a");
}
...
function pap_quest_init() {
    ...
    level scene::init(#"hash_4703db4679985a0a");
    ...
    if (zm_utility::is_standard()) {
        ...
        scene::init(#"hash_3fc4387aaad42956");
...
function function_ce84849b(var_5ea5c94d) {
    ...
    if (zm_custom::function_901b751c(#"zmpapenabled") == 2) {
        ...
        level scene::init(#"hash_437ea4a503c2e1c7");
        level scene::init(#"hash_c877e10a252f5a8");
...
function function_ff356649() {
    ...
    if (self zm_characters::is_character(array(#"hash_7180c6cf382f6010", #"hash_14e91ceb9a7b3eb6"))) {
        var_3608d414[var_3608d414.size] = #"hash_3f6bf8f6cd5e63ff";
        var_3608d414[var_3608d414.size] = #"hash_3f6bf7f6cd5e624c";
        var_5fe18b90 = #"hash_43376c821d8f3cef";
        str_vo = array::random(var_3608d414);
        self zm_vo::vo_say(str_vo, 0.5, 1, 9999, 1);
        if (str_vo == var_3608d414[1]) {
        ...
        if (self zm_characters::is_character(array(#"hash_68255d9ce2a09382", #"hash_1a427f842f175b3c"))) {
            var_3608d414[var_3608d414.size] = #"hash_57e4fdf6dacd37be";
            var_3608d414[var_3608d414.size] = #"hash_57e4fef6dacd3971";
            var_3608d414[var_3608d414.size] = #"hash_57e4fbf6dacd3458";
        } else if (self zm_characters::is_character(array(#"hash_f531a8c2df891cc", #"hash_26072a3b34719d22"))) {
            var_3608d414[var_3608d414.size] = #"hash_45e1aff6d067b934";
            var_3608d414[var_3608d414.size] = #"hash_45e1b0f6d067bae7";
            var_3608d414[var_3608d414.size] = #"hash_45e1b1f6d067bc9a";
        } else {
            var_3608d414[var_3608d414.size] = #"hash_713782f6e8f4d5bd";
            var_3608d414[var_3608d414.size] = #"hash_713781f6e8f4d40a";
            var_3608d414[var_3608d414.size] = #"hash_713780f6e8f4d257";
        }
        str_vo = array::random(var_3608d414);
        if (isdefined(str_vo)) {
...
function function_5a06e111(player) {
    ...
    foreach (player in getplayers()) {
        player forcestreambundle(#"hash_3837f3541694073f");
    }
...
function function_62cca067(var_46bfea0) {
    self endon(#"death");
    level endon(#"hash_63519505a67adc42");
    ...
    if (isdefined(str_fxanim)) {
        level thread scene::play(#"hash_4cd11950522f601a");
    }
            ...
            for (i = 0; i < a_players.size; i++) {
                if (isdefined(a_players[i])) {
                    if (zombie_utility::is_player_valid(a_players[i]) && a_players[i] util::is_player_looking_at(self.origin)) {
                        ...
                        level flag::set(#"hash_63519505a67adc42");
                        break;
                    }
                }
                wait(0.1);
...
function function_ed6e29a3() {
    self endon(#"death");
    self waittill(#"hash_27012da503c0c6a9");
...
function function_6449c41f(s_spawn_loc) {
    ...
    } else if (s_spawn_loc.script_int == 2) {
        return 1;
    } else {
        return 0;
    }
...
function function_79c0fdf3() {
    self endon(#"death");
    level endon(#"end_game", #"hash_5c4e01cb4d3a315", #"hash_354f85bda5493cca");
    wait(20);
    while (1) {
        ...
        if (isdefined(a_players)) {
            for (i = 0; i < a_players.size; i++) {
                if (zm_utility::is_player_valid(a_players[i]) && a_players[i] util::is_looking_at(self, 0.9, 1)) {
                    ...
                    level notify(#"hash_5c4e01cb4d3a315");
                    break;
                }
                wait(0.1);
            }
...
function function_551b832a() {
    self endon(#"death");
    level endon(#"end_game", #"hash_354f85bda5493cca");
    while (1) {
...
function function_3ca8556b(s_ride) {
    ...
    level flag::wait_till(#"hash_354f85bda5493cca");
...
function function_fd484520() {
    level endon(#"hash_354f85bda5493cca");
    var_cfb8558b = getent("trigger_pegasus_takeof", "targetname");
    while (1) {
...
function function_e11818f4() {
    while (1) {
        ...
        if (level flag::get(#"hash_32ff7a456732ef09") && level.var_9ab86086) {
            ...
            level flag::set(#"hash_354f85bda5493cca");
            break;
        }
    }
...
function function_fe0a763c() {
    ...
    a_players = util::get_active_players();
    foreach (player in a_players) {
        player val::set(#"hash_354f85bda5493cca", "takedamage", 0);
    }
    ...
    foreach (player in a_players) {
        if (zm_utility::is_player_valid(player)) {
            ...
            player forcestreambundle(#"hash_4703db4679985a0a");
            player forcestreambundle(#"hash_6c19cacedbc244f");
            player forcestreambundle(#"hash_437ea4a503c2e1c7");
            player forcestreambundle(#"hash_c877e10a252f5a8");
        }
    }
    var_3edd432d = getent("perseus_scene", "targetname");
    var_5902d194 = getent("perseus_sword", "targetname");
    if (!isdefined(var_cb5f57f5)) {
        var_cb5f57f5 = [];
    } else if (!isarray(var_cb5f57f5)) {
        var_cb5f57f5 = array(var_cb5f57f5);
    }
    var_cb5f57f5[var_cb5f57f5.size] = var_3edd432d;
    if (!isdefined(var_cb5f57f5)) {
        var_cb5f57f5 = [];
    } else if (!isarray(var_cb5f57f5)) {
        var_cb5f57f5 = array(var_cb5f57f5);
    }
    var_cb5f57f5[var_cb5f57f5.size] = var_5902d194;
    if (!isdefined(var_cb5f57f5)) {
        var_cb5f57f5 = [];
    } else if (!isarray(var_cb5f57f5)) {
        var_cb5f57f5 = array(var_cb5f57f5);
    ...
    scene::add_scene_func(#"hash_3837f3541694073f", &function_a965580a, "play");
    scene::add_scene_func(#"hash_3837f3541694073f", &function_e45ae8f4, "skip_started");
    scene::add_scene_func(#"hash_3837f3541694073f", &function_366b0011, "done");
    ...
    s_scene scene::play(#"hash_3837f3541694073f", var_cb5f57f5);
    wait(0.1);
    zm_bgb_anywhere_but_here::function_886fce8f(1);
    level.var_e120ae98 = &function_5cfbc408;
    level notify(#"hash_1972338eeefcc8bd");
    ...
    level notify(#"hash_5137c89980de258d");
    if (!level flag::get(#"hash_1981012de509765d")) {
        player = array::random(util::get_active_players());
...
function function_ac395ad7() {
    self endon(#"death");
    while (1) {
        self waittill(#"hash_2f71dec4485c8a24");
        foreach (player in getplayers()) {
...
function function_e45ae8f4(a_ents) {
    ...
    s_result = undefined;
    s_result = level waittilltimeout(2.5, #"hash_16fdbcebe1ccd95c");
...
function function_db68db95(s_pos) {
    self endon(#"death");
    self val::set(#"hash_138f3ab4bdfe1eb", "freezecontrols", 1);
    level waittill(#"hash_16fdbcebe1ccd95c");
    if (!level flag::get(#"hash_1981012de509765d")) {
    ...
    self val::reset(#"hash_354f85bda5493cca", "takedamage");
    self val::reset(#"hash_138f3ab4bdfe1eb", "freezecontrols");
    self unlink();
    waitframe(1);
...
function function_5a4d8124(var_5ea5c94d) {
    ...
    scene::add_scene_func(#"hash_3fc4387aaad42956", &function_bc27738a, "init");
...
function function_c3bbdc48(a_ents) {
    level.var_ba012aad = a_ents[#"hash_74894455c8945926"];
}
...
function function_5a557985(a_ents) {
    mdl_door = a_ents[#"prop 2"];
    var_d420f7c5 = a_ents[#"prop 1"];
    if (isdefined(var_d420f7c5)) {
        var_d420f7c5 thread function_bb898a46();
    }
    if (isdefined(mdl_door)) {
        mdl_door thread function_697a602a(var_d420f7c5);
    }
    var_7a930e3d = getent("clip_cage_chain", "targetname");
    var_7a930e3d thread function_bb898a46();
}
    ...
    while (1) {
        ...
        if (isdefined(s_notify.weapon) && s_notify.weapon.isheroweapon === 1) {
            ...
            if (str_flag == #"hash_61de3b8fe6f6a35") {
                level flag::set(#"hash_2643e0478beaf40a");
...
function function_f41b632f() {
    ...
    level thread scene::play(#"hash_3fc4387aaad42956", "open");
    s_scene = struct::get("tag_align_red_eagles");
    s_scene scene::play(#"hash_67e6cacf31e57dcc", "fly_to_hover");
    level thread function_e39d6ea2(#"hash_74894455c8945926");
    wait(0.5);
...
// Size: 0x334
function function_697a602a(var_d420f7c5) {
    s_scene = struct::get("tag_align_red_eagles");
    var_c6c0744e = var_d420f7c5 gettagorigin("eagle_link_jnt");
    if (isdefined(var_c6c0744e)) {
        var_a595fc19 = util::spawn_model("tag_origin", var_c6c0744e, var_d420f7c5.angles);
    }
    if (isdefined(var_a595fc19)) {
        var_a595fc19 linkto(var_d420f7c5, "eagle_link_jnt");
    ...
    wait(0.5);
    level notify(#"hash_6619462ca8d0a17f");
    scene::add_scene_func(#"hash_67e6cdcf31e582e5", &function_5297c54, "fly_to_hover");
    s_scene scene::play(#"hash_67e6cdcf31e582e5", "fly_to_hover");
    level thread function_e39d6ea2(#"hash_74894355c8945773");
    wait(0.5);
...
function function_5297c54(a_ents) {
    level.var_6aec40b = a_ents[#"hash_74894355c8945773"];
}
...
function function_1dceae50(a_ents) {
    var_7011c777 = a_ents[#"prop 1"];
    if (isdefined(var_7011c777)) {
        level waittill(#"hash_6619462ca8d0a17f");
        if (isdefined(var_7011c777)) {
            var_7011c777 delete();
        }
    }
...
function function_e39d6ea2(var_b40c658f) {
    s_scene = struct::get("tag_align_red_eagles");
    if (var_b40c658f == #"hash_74894355c8945773") {
...
function function_41d05cb0() {
    level endon(#"egg_free", #"hash_2643e0478beaf40a");
...
function function_d1f0f2db() {
    ...
    level flag::wait_till(#"cage_dropped");
    ai_gegenees = zombie_gegenees_util::function_2ce6dcd4(level.var_b3d6ef3b[0], struct::get("serpent_cage_defe"), level.round_number);
    if (isalive(ai_gegenees)) {
        ai_gegenees.var_126d7bef = 1;
        ai_gegenees.ignore_round_spawn_failsafe = 1;
        ai_gegenees.b_ignore_cleanup = 1;
...
function function_d8db57f6() {
    level flag::wait_till(#"hash_2643e0478beaf40a");
    wait(1);
    var_71da3f5a = getentarray("cage_defender", "targetname");
    foreach (var_3e9d57b3 in var_71da3f5a) {
...
function function_2f0f6f0() {
    ...
    while (1) {
        ...
        var_cb939ad4 = array::random(var_228cf3d);
        ...
        for (i = 0; i < randomint(6); i++) {
            ...
            var_e5d078 = util::spawn_model(var_cb939ad4, s_spawnpt.origin + v_offset, s_spawnpt.angles + (randomint(90), randomint(90), randomint(90)));
            if (isdefined(var_e5d078)) {
                var_e5d078 thread function_c67711a8(s_goal, n_time);
            }
...
function function_23f28dd1(var_5ea5c94d) {
    ...
    foreach (var_ae696aa0 in level.var_57daa86c) {
        var_ae696aa0.var_fcfc80dd = util::spawn_model("tag_origin", var_ae696aa0.origin);
    ...
    getent("pap_arena", "targetname") delete();
...
function function_1707def1() {
    level endon(#"hash_4f95bcc33328b665");
    ...
    while (1) {
        foreach (s_fasttravel in var_3682878e) {
            ...
            if (isdefined(a_players) && isalive(a_players[0])) {
                ...
                level notify(#"hash_4f95bcc33328b665");
            }
        }
        wait(0.1);
    }
...
function function_20bd10b1() {
    ...
    wait(0.5);
    level flag::set(#"hash_28699850caf3ead");
    function_76678dd2();
    function_b896f640();
}
...
function function_c97fc55b() {
    self.var_fcfc80dd clientfield::set("" + #"spartoi_reassemble_clientfield", 1);
    self.var_fcfc80dd moveto(self.s_pt.origin, 1);
    self.var_fcfc80dd waittill(#"movedone");
...
function function_a8f9c9c4() {
    ...
    if (self == level.var_6aec40b) {
        var_b40c658f = #"hash_74894355c8945773";
        str_scene = "aib_vign_cust_zm_red_eagle_1";
    } else {
        var_b40c658f = #"hash_74894455c8945926";
        str_scene = "aib_vign_cust_zm_red_eagle_2";
    }
    level flag::wait_till(#"hash_28699850caf3ead");
...
function function_96442f27(var_61456417) {
    ...
    case 12:
        ...
        break;
    case 11:
        level scene::play(#"hash_437ea4a503c2e1c7", "break01");
        break;
    case 10:
        level scene::play(#"hash_c877e10a252f5a8", "break01");
        break;
    case 7:
        level scene::play(#"hash_6c19cacedbc244f", "break02");
        break;
    case 6:
        level scene::play(#"hash_437ea4a503c2e1c7", "break02");
        break;
    case 5:
        level scene::play(#"hash_c877e10a252f5a8", "break02");
        break;
    case 2:
        level scene::play(#"hash_6c19cacedbc244f", "destroy");
        break;
    case 1:
        level scene::play(#"hash_437ea4a503c2e1c7", "destroy");
        break;
    case 0:
        level scene::play(#"hash_c877e10a252f5a8", "destroy");
        break;
    }
}
...
function function_deb1409b(var_b40c658f) {
    ...
    } else if (isdefined(level.var_6aec40b)) {
...
function function_6e57d6c6(var_5ea5c94d) {
    ...
    if (zm_custom::function_901b751c(#"zmpapenabled") == 2) {
        ...
        level flag::wait_till_all(var_af2013df);
        wait(3);
        function_deb1409b(#"hash_74894355c8945773");
        function_deb1409b(#"hash_74894455c8945926");
    }
    level flag::set(#"zm_red_fasttravel_open");
...
function on_player_spawned() {
    ...
    if (self zm_characters::is_character(array(#"hash_7180c6cf382f6010", #"hash_14e91ceb9a7b3eb6"))) {
        self.var_3608d414 = [];
        self.var_3608d414[self.var_3608d414.size] = #"hash_5fb45a950319ba97";
        self.var_3608d414[self.var_3608d414.size] = #"hash_5fb459950319b8e4";
        self.var_3608d414[self.var_3608d414.size] = #"hash_5fb45c950319bdfd";
        self.var_3608d414[self.var_3608d414.size] = #"hash_5fb45b950319bc4a";
...
function function_e432aeb6(str_category, var_39acfdda) {
    str_vo = array::random(self.var_3608d414);
    if (isdefined(str_vo)) {
...
function function_9bc19458(str_vo) {
    self endon(#"death");
    arrayremovevalue(self.var_3608d414, str_vo);
    self zm_vo::vo_say(str_vo, 0.5, 1, 9999, 1);
...
function function_118e5303(str_category, var_39acfdda) {
    var_3608d414 = array(#"hash_fb4780da8c3e82e", #"hash_fb4790da8c3e9e1", #"hash_fb4760da8c3e4c8", #"hash_fb4770da8c3e67b", #"hash_fb47c0da8c3eefa");
    str_vo = array::random(var_3608d414);
...
function function_e7e0d76b(str_category, var_39acfdda) {
    var_3608d414 = array(#"hash_45f33af562e8c0c3", #"hash_45f339f562e8bf10", #"hash_45f33cf562e8c429", #"hash_45f33bf562e8c276", #"hash_45f33ef562e8c78f");
    str_vo = array::random(var_3608d414);
...
function function_3e5c42f5(e_holder, w_item) {
    ...
    zm_crafting::function_d1f16587(#"hash_3f832ccf78265a33", &function_7250e6b9);
    switch (w_item.name) {
...
function function_df55fcc8(e_player) {
    ...
    can_use = can_use & !e_player hasweapon(level.var_49d60273);
    if (can_use) {
