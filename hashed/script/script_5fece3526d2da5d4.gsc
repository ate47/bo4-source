...
class cct_shared_ingame_objective : cluielem {
    ...
    function set_objectivetext(player, value) {
        player clientfield::function_9bf78ef8(var_47e79fc, "objectiveText", value);
    }
    ...
    function set_state(player, state_name) {
        ...
        if (#"hash_5ba30c4069a3b28" == state_name) {
            player clientfield::function_9bf78ef8(var_47e79fc, "_state", 17);
            return;
        }
        if (#"dynobj_killmantises" == state_name) {
            player clientfield::function_9bf78ef8(var_47e79fc, "_state", 18);
            return;
        }
        if (#"hash_83700757d6b9194" == state_name) {
            player clientfield::function_9bf78ef8(var_47e79fc, "_state", 19);
            return;
        }
        if (#"dynobj_earnmantis" == state_name) {
            player clientfield::function_9bf78ef8(var_47e79fc, "_state", 20);
            return;
        }
        if (#"hash_2a4442540584316a" == state_name) {
            player clientfield::function_9bf78ef8(var_47e79fc, "_state", 21);
            return;
        }
        if (#"dynobj_earnstraferun" == state_name) {
            player clientfield::function_9bf78ef8(var_47e79fc, "_state", 22);
            return;
        }
        if (#"hash_1a051da4d150816" == state_name) {
            player clientfield::function_9bf78ef8(var_47e79fc, "_state", 23);
            return;
        }
        if (#"dynobj_killtoearnnomadks" == state_name) {
            player clientfield::function_9bf78ef8(var_47e79fc, "_state", 24);
            return;
        }
        if (#"hash_21962bee0a15424" == state_name) {
            player clientfield::function_9bf78ef8(var_47e79fc, "_state", 25);
            return;
        }
        if (#"dynobj_killzombies" == state_name) {
            player clientfield::function_9bf78ef8(var_47e79fc, "_state", 26);
            return;
        }
        if (#"hash_29a3c52abd286a3d" == state_name) {
            player clientfield::function_9bf78ef8(var_47e79fc, "_state", 27);
            return;
        }
        if (#"dynobj_earndart" == state_name) {
            player clientfield::function_9bf78ef8(var_47e79fc, "_state", 28);
            return;
        }
        if (#"hash_34061eae676df48d" == state_name) {
            player clientfield::function_9bf78ef8(var_47e79fc, "_state", 29);
            return;
        }
        if (#"dynobj_teamdefend" == state_name) {
            player clientfield::function_9bf78ef8(var_47e79fc, "_state", 30);
            return;
        }
        if (#"hash_4bfdec8101cde9e7" == state_name) {
            player clientfield::function_9bf78ef8(var_47e79fc, "_state", 31);
            return;
        }
        if (#"dynobj_killspawnbeacons" == state_name) {
            player clientfield::function_9bf78ef8(var_47e79fc, "_state", 32);
            return;
        }
        if (#"hash_1a4b4231363359c4" == state_name) {
            player clientfield::function_9bf78ef8(var_47e79fc, "_state", 33);
            return;
        }
        if (#"dynobj_killwiretrappedenemies" == state_name) {
            player clientfield::function_9bf78ef8(var_47e79fc, "_state", 34);
            return;
        }
        if (#"hash_5c25a457d21d00a3" == state_name) {
            player clientfield::function_9bf78ef8(var_47e79fc, "_state", 35);
            return;
        }
        if (#"oneline" == state_name) {
            player clientfield::function_9bf78ef8(var_47e79fc, "_state", 36);
            return;
        }
        if (#"hash_6e90224596225271" == state_name) {
            player clientfield::function_9bf78ef8(var_47e79fc, "_state", 37);
            return;
        }
        if (#"dynobj_killenemies" == state_name) {
            player clientfield::function_9bf78ef8(var_47e79fc, "_state", 38);
            return;
        }
        if (#"hash_75d2922ca26f2a88" == state_name) {
            player clientfield::function_9bf78ef8(var_47e79fc, "_state", 39);
            return;
        }
