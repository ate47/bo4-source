...
struct root {
    fixedpoint kd;
    fixedpoint hash_49ebf2675743e7eb;
    fixedpoint hash_49ebf1675743e638;
    int32 rank;
    int32 kills;
    match_header match;
    int32 score;
    int32 hash_56832bbcf195a9d3;
    string hash_3b10bf5cc604677d;
    telemetry_header telemetry;
    int32 grenadesused;
    int32 bestkillstreak;
    string collectibles;
    fixedpoint hash_5d9b05c61b08296c;
    int32 hash_31fc0b4df25cc50d;
    int32 hash_5563ef374a80dc1d;
    double primaryloadoutweapon;
    int32 playertime;
    fixedpoint accuracy;
    int32 spawnid;
    ...
    int32 rankxp;
    fixedpoint hash_475d9beecef8b15f;
    int32 wallrun_time;
    int32 assists;
    int32 hash_dff62c9437ddfa;
    int32 hash_5e8a9a502b3f3df8;
    fixedpoint hash_491587fc34c54122;
    int32 sprint_time;
    int32 shotshit;
    string username;
    int32 headshots;
