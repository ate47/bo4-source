...
#include scripts/mp_common/item_drop.csc;
    ...
    if (isdefined(level.var_93c59949[var_aa9f8f87.name])) {
        ...
        foreach (var_ee110db8 in var_cf36f90d) {
            if (isdefined(var_ee110db8.var_52a66db0)) {
                jumpiffalse(stash.targetname !== var_ee110db8.var_52a66db0) LOC_00000216;
            } else {
            LOC_00000216:
...
function private function_216a69d6(var_9f19fcb6, reset) {
    ...
    for (pointindex = 0; var_c041d1bd < var_418a2e03.size; pointindex++) {
        ...
        if (isdefined(self.var_b91441dd.var_7fb0967b) && !var_a9826383) {
            ...
            jumpcmp(var_1ba7b9c8.size < 0) LOC_0000051c;
        } else {
        LOC_0000051c:
...
function private function_e25c9d12(&var_8107154f, spawncount, stashitem = 0, &var_a1b91de4 = undefined) {
    ...
    for (pointindex = 0; var_f5111345 < arraykeys.size && var_7a7ab6bf < self.count; pointindex++) {
        ...
        if (isdefined(var_a6762160) && var_a6762160 != "") {
            ...
            jumpiffalse(isdefined(scriptbundle) && isdefined(scriptbundle.type) && (scriptbundle.type == #"itemspawnlist" || scriptbundle.type == #"itemspawnlistalias")) LOC_00000e16;
...
LOC_000000a2:
    ...
    foreach (group in var_1d9375fc) {
        ...
        if (isdefined(var_f38d5b52[group.target])) {
            jumpiftrue(isdefined(var_b91441dd.supplystash) && var_b91441dd.supplystash) LOC_0000025e;
        } else {
        LOC_0000025e:
