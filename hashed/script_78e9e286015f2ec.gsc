...
function init() {
    ...
    if (zm_utility::is_ee_enabled()) {
        level.var_f13364b4.a_n_codes[2265] = {#var_d9d9d617:&function_607f8829, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[2739] = {#var_d9d9d617:&function_ff176ced, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[2652] = {#var_d9d9d617:&function_95787ed2, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[7632] = {#var_d9d9d617:&function_3887862d, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[3667] = {#var_d9d9d617:&function_d89fe502, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[6662] = {#var_d9d9d617:&function_ccbd2e6c, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[3279] = {#var_d9d9d617:&function_ccbd2e6c, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[3255] = {#var_d9d9d617:&function_48f83a1d, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[9277] = {#var_d9d9d617:&function_f5468d9b, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[7433] = {#var_d9d9d617:&function_addac768, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[6853] = {#var_d9d9d617:&function_a7f962c9, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[4376] = {#var_d9d9d617:&function_8e63da67, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[4728] = {#var_d9d9d617:&function_b015442e, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[4867] = {#var_d9d9d617:&function_7b716b93, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[8463] = {#var_d9d9d617:&function_f4c88568, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[7836] = {#var_d9d9d617:&function_23dac63d, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[2666] = {#var_d9d9d617:&function_23dac63d, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[7225] = {#var_d9d9d617:&function_9e9664bd, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[2582] = {#var_d9d9d617:&function_8a9baa13, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[7283] = {#var_d9d9d617:&function_8a9baa13, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[3825] = {#var_d9d9d617:&function_bb800be7, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[7853] = {#var_d9d9d617:&function_77085b, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[7664] = {#var_d9d9d617:&function_8606278d, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[1841] = {#var_d9d9d617:&function_b54f6326, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[8459] = {#var_d9d9d617:&function_685d3dab, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[5653] = {#var_d9d9d617:&function_7d008839, #var_544c05c6:6};
        level.var_f13364b4.a_n_codes[9296] = {#var_d9d9d617:&function_a823412a, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[1111] = {#var_d9d9d617:&function_a823412a, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[8368] = {#var_d9d9d617:&function_90dbeb67, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[7268] = {#var_d9d9d617:&function_90dbeb67, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[5683] = {#var_d9d9d617:&function_6755931f, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[5433] = {#var_d9d9d617:&function_b94ecbd8, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[8333] = {#var_d9d9d617:&function_ac121b1c, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[1] = {#var_d9d9d617:&function_7e966dbe, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[2] = {#var_d9d9d617:&function_9b96f239, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[3] = {#var_d9d9d617:&function_c36b1f94, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[4] = {#var_d9d9d617:&function_27d39a4f, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[1001] = {#var_d9d9d617:&function_998eba45, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[1002] = {#var_d9d9d617:&function_be76c1b8, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[1003] = {#var_d9d9d617:&function_fadd27d6, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[1004] = {#var_d9d9d617:&function_cd2168cb, #var_544c05c6:1};
        level.var_f13364b4.a_n_codes[1005] = {#var_d9d9d617:&function_6b002f3c, #var_544c05c6:1};
        level thread function_6338402();
        level.var_f13364b4.var_8deb4ed2 = 7626;
        level.var_f13364b4.a_n_codes[level.var_f13364b4.var_8deb4ed2] = {#var_d9d9d617:&function_c9dcb3aa, #var_544c05c6:1};
...
function function_f359c8a0(s_key, e_player) {
    ...
    case #"number":
        ...
        /#
            iprintlnbold("<unknown string>" + s_key.script_string + "<unknown string>" + s_key.script_int);
        #/
...
function function_4696e086(var_5c0c59ca = undefined, var_64d0790a = undefined) {
    var_c97e80f5 = randomintrange(0, 10000);
    while (isdefined(level.var_f13364b4.a_n_codes[var_c97e80f5])) {
        var_c97e80f5 = randomintrange(0, 10000);
        /#
            iprintlnbold("<unknown string>" + var_c97e80f5 + "<unknown string>");
        #/
    }
    if (isdefined(var_5c0c59ca) && isdefined(var_64d0790a)) {
        level.var_f13364b4.a_n_codes[var_c97e80f5] = {#var_d9d9d617:var_64d0790a, #var_544c05c6:var_5c0c59ca};
    }
    return var_c97e80f5;
}
...
function function_352f47ae(var_2ac83b81) {
    /#
        assert(isdefined(var_2ac83b81[3]), "<unknown string>");
    #/
...
function function_cd7e0989(n_code) {
    if (!isdefined(level.var_f13364b4.a_n_codes[n_code])) {
        ...
        playsoundatposition("zmb_comp_keypad_action_fail", self.origin);
        level thread zm_white_util::function_ec34b5ee(#"hash_74933b1a2d246442");
    } else if (level.var_f13364b4.a_n_codes[n_code].var_544c05c6 <= 0) {
        /#
            iprintlnbold("<unknown string>");
        #/
        playsoundatposition("zmb_comp_keypad_action_fail", self.origin);
        level thread zm_white_util::function_ec34b5ee(#"hash_74933b1a2d246442");
    } else if (isdefined(level.var_f13364b4.a_n_codes[n_code].var_d9d9d617)) {
        /#
            iprintlnbold("<unknown string>");
        #/
...
function function_ff176ced() {
    level thread namespace_fddd83bd::brew();
}
...
function function_c9dcb3aa() {
    ...
    /#
        iprintlnbold("<unknown string>" + level.var_f13364b4.var_a7450be4);
    #/
}
...
function function_69dd6c5b() {
    if (level flag::get(#"hash_3ee874ebee843004")) {
        ...
        /#
            iprintlnbold("<unknown string>" + level.var_f13364b4.var_72c3e48c);
        #/
    } else {
...
function function_97ab5da4() {
    ...
    if (level flag::get_all(a_flags)) {
        ...
        /#
            iprintlnbold("<unknown string>" + level.var_f13364b4.var_98e79e76);
        #/
    } else {
...
// Size: 0x124
function function_66365668(var_73cc7cdd) {
    var_aa2d940c = "tag_code_digit_0_" + int(var_73cc7cdd[0]);
    var_bfd7bf60 = "tag_code_digit_1_" + int(var_73cc7cdd[1]);
    var_ce0d5bcb = "tag_code_digit_2_" + int(var_73cc7cdd[2]);
    var_e38486c9 = "tag_code_digit_3_" + int(var_73cc7cdd[3]);
...
function function_da24090c(n_code) {
    var_73cc7cdd[0] = floor(n_code / 1000);
    n_code = n_code % 1000;
    var_73cc7cdd[1] = floor(n_code / 100);
    n_code = n_code % 100;
    var_73cc7cdd[2] = floor(n_code / 10);
    n_code = n_code % 10;
    var_73cc7cdd[3] = n_code;
    return var_73cc7cdd;
}
