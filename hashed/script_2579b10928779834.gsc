...
// Namespace notetracks/namespace_467800e2
// Params 0, eflags: 0x2
...
// Size: 0x4c
function private addsurfacenotetrackfxhandler(localclientnum, notetrack, var_4cff8243) {
    entity = self;
    entity thread handlesurfacenotetrackfx(localclientnum, notetrack, var_4cff8243);
}
...
// Size: 0xb0
function private handlesurfacenotetrackfx(localclientnum, notetrack, var_4cff8243) {
    entity = self;
    entity endon(#"death");
    while (1) {
        entity waittill(notetrack);
        fxname = entity getaifxname(localclientnum, var_4cff8243);
        if (isdefined(fxname)) {
