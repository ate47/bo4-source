...
#include scripts/zm/zm_office_zones.gsc;
...
function function_b540b576() {
    ...
    level.var_5849269a[0] = {#var_42a7972a:var_1c8e90b4, #in_inventory:0};
    level.var_5849269a[1] = {#var_42a7972a:var_ab6a16ff, #in_inventory:0};
    level.var_5849269a[2] = {#var_46db68fd:1, #var_42a7972a:var_e6c1fe70, #in_inventory:0};
    level.var_5849269a[3] = {#var_42a7972a:var_51ba7b4a, #in_inventory:0};
    level.var_5849269a[4] = {#var_42a7972a:var_68e586cf, #in_inventory:0};
...
function function_8352562a() {
    ...
    while (1) {
        ...
        if (isdefined(level.var_b63bccb7)) {
            ...
            wait(2);
            zm_hms_util::function_52c3fe8d(s_log.var_42a7972a, level.var_94b00cff.origin);
            var_e578920c++;
...
function dog_ambush() {
    ...
    while (var_a9e4d1ee > 0) {
        ...
        foreach (loc in level.zm_loc_types[#"dog_location"]) {
            ...
            } else if (loc.zone_name == var_c6bd50df) {
