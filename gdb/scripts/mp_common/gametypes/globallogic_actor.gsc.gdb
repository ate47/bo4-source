...
STRING "<dev string:x41>" 0xfbc
# globallogic_actor::callback_actordamage@dec
STRING "<dev string:x4c>" 0xfcc
# globallogic_actor::callback_actordamage@e00
STRING "<dev string:x59>" 0xfe0
# globallogic_actor::callback_actordamage@e1c
