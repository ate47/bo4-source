...
// Size: 0x60
function function_8f84839b(localclientnum) {
    var_b4f82253 = [];
    var_b4f82253[0] = 2;
    var_b4f82253[1] = 1;
    var_b4f82253[2] = 3;
    var_b4f82253[3] = 0;
    return var_b4f82253[localclientnum];
}
...
// Size: 0x3fa
function function_93a4f3c5(localclientnum, draftcharacter, var_6d440bed = 0) {
...
// Size: 0x74
function function_71a9fb67(localclientnum, draftcharacter, var_22d83f76, var_6d440bed = 0) {
    if (function_93a4f3c5(localclientnum, draftcharacter, var_6d440bed)) {
...
function function_f39eac8f(var_dde5862c, var_e1d25028) {
    ...
    foreach (i, xuid in var_dde5862c) {
        ...
        for (j = 0; j < 5; j++) {
            luaindex = j + 1;
            var_ede6a167 = getuimodel(var_e1d25028, luaindex);
            var_29c529c6 = getuimodel(var_ede6a167, "xuid");
            if (!isdefined(var_29c529c6)) {
                continue;
            }
            var_f33ed25a = getuimodelvalue(var_29c529c6);
...
// Size: 0x43e
function update_team(localclientnum, var_6d440bed = 0) {
    ...
    for (i = 0; i < 5; i++) {
        ...
        if (isdefined(var_e1d25028)) {
            ...
            function_71a9fb67(localclientnum, draftcharacter, var_22d83f76, var_6d440bed);
        }
    }
}
...
function setup_team(localclientnum) {
    ...
    var_9b6e828a = array::randomize(array(#"hash_af61c12c74d81e1", #"hash_51995900fb23215e", #"hash_42324080ddc706b1"));
    for (i = 0; 1; i++) {
...
function function_393e6d42() {
    ...
    while (1) {
        waitresult = undefined;
        waitresult = level waittill(#"hash_26382205e27d5717");
                ...
                if (isdefined(var_2d0192e5) && isdefined(var_2d0192e5.xuid)) {
                    ...
                    if (xuid === waitresult.xuid) {
                        if (waitresult.gesture_index == -1) {
                            ...
                            var_d0b01271 function_1e63c21d();
