...
#include scripts/zm/weapons/zm_weap_sword_pistol.gsc;
#include scripts/zm/weapons/zm_weap_scepter.gsc;
#include scripts/zm/weapons/zm_weap_hammer.gsc;
#include scripts/zm/weapons/zm_weap_chakram.gsc;
...
function function_603af7a8(weapon) {
    ...
    /#
        level thread zm_devgui::function_bcc8843e(function_a16a090d(weapon), "<unknown string>", "<unknown string>");
    #/
}
