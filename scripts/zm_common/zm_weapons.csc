...
#include scripts/zm/weapons/zm_weap_sword_pistol.csc;
#include scripts/zm/weapons/zm_weap_scepter.csc;
#include scripts/zm/weapons/zm_weap_hammer.csc;
#include scripts/zm/weapons/zm_weap_chakram.csc;
