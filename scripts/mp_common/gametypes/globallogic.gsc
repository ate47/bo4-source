...
#include scripts/weapons/mp/weapons.gsc;
...
#include scripts/mp_common/rat.gsc;
...
#include scripts/mp_common/gametypes/shellshock.gsc;
#include scripts/mp_common/gametypes/serversettings.gsc;
#include scripts/mp_common/gametypes/round.gsc;
#include scripts/mp_common/gametypes/radar_sweeps.gsc;
...
#include scripts/mp_common/gametypes/clientids.gsc;
...
#include scripts/mp_common/arena.gsc;
...
#include scripts/core_common/globallogic/globallogic_shared.gsc;
...
function function_a4156fb2() {
    ...
    while (1) {
        ...
        foreach (player in enemyplayers) {
            ...
            } else if (isdefined(player.strobed) && player.strobed) {
