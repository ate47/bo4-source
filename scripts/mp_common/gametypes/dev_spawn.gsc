...
function function_f084faed() {
    /#
        if (!isdefined(level.var_2f11d3e5)) {
            ...
            level.var_2f11d3e5[#"hash_200088ed1400621f"] = "<unknown string>";
            level.var_2f11d3e5[#"hash_200089ed140063d2"] = "<unknown string>";
            level.var_2f11d3e5[#"hash_754a59ee5b52f897"] = "<unknown string>";
            level.var_2f11d3e5[#"hash_754a5aee5b52fa4a"] = "<unknown string>";
            level.var_2f11d3e5[#"demolition_overtime"] = "<unknown string>";
            level.var_2f11d3e5[#"hash_69438a51aacbf824"] = "<unknown string>";
            level.var_2f11d3e5[#"hash_69438d51aacbfd3d"] = "<unknown string>";
            level.var_2f11d3e5[#"hash_16ca7b5aee87513c"] = "<unknown string>";
            level.var_2f11d3e5[#"hash_4bcbc46ff5f13ed4"] = "<unknown string>";
            level.var_2f11d3e5[#"hash_4bcbc76ff5f143ed"] = "<unknown string>";
            level.var_2f11d3e5[#"hash_4bcbc66ff5f1423a"] = "<unknown string>";
