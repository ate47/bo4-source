...
function event_handler[gametype_init] main(eventstruct) {
    ...
    level.bountyDepositSiteCaptureTime = max(getgametypesetting(#"hash_7bc0266904794722"), 1);
    ...
    level.lastStandTimer = getgametypesetting(#"hash_280f85f44f115cac");
...
function private function_f9a7a3d8(helicopter) {
    ...
    threadendon function_5db7fc11(helicopter);
}
