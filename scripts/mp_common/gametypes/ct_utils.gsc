...
#include script_446da318d52124e0;
...
#include script_2cc4bd7902c3f711;
#include script_d92b57cc5ff92a6;
#include script_5fece3526d2da5d4;
#include script_2ceedb8f6f1237ee;
#include script_1268b5fd7df90334;
#include script_677f3ac857d46f22;
#include script_7c4b080c0766fedc;
...
function function_b0b54bd5(var_92c8bf38, var_2cb0d724) {
    ...
    s_data = {#var_dd646e5:var_2cb0d724, #str_state:var_92c8bf38};
...
function function_7a21ac57(n_type = 0, var_61ca8276, var_9d99d28, n_silver, n_gold, var_c7165970) {
    ...
    if (!isdefined(level.var_b613db22[str_map][str_character][var_d0c7d280])) {
        level.var_b613db22[str_map][str_character][var_d0c7d280] = {#var_d775ff6a:n_type, #var_d2b50dd9:var_61ca8276};
    }
...
function function_9d4708dc(var_52487c6d, str_map = function_f0149e2f(), str_character = level.var_820c5561, var_d0c7d280 = level.var_d0c7d280) {
    ...
    case 0:
        if (var_3bb92d22 > var_52487c6d) {
            ...
            return {#var_d2b50dd9:var_52487c6d, #var_4a4d7e27:1};
        } else {
...
function function_9ab507a9(var_76b15be0, var_8e92afbd, var_da2d40e, var_e380ff6c, var_40347291 = 1, b_disconnectpaths = 0) {
    ...
    level.a_s_colbounds[var_76b15be0] = {#b_disconnectpaths:b_disconnectpaths, #var_40347291:var_40347291, #var_e380ff6c:var_e380ff6c, #var_a90a2d1:var_da2d40e, #var_5d90b13a:var_8e92afbd, #a_effects:[], #targetname:var_76b15be0};
