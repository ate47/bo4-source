...
function function_9b9525e9() {
    ...
    level notify(#"hash_3ab9939f39384a22");
    level notify(#"hash_f7708cd40efef27");
    ...
    level notify(#"hash_4afb8126d24973f0");
    level notify(#"hash_61f31e34f33433a3");
    level notify(#"hash_154c156362e00843");
    ct_utils::function_e9ab1003("s_nomad_tripwire_obj2_goto");
    function_45d34164(array(#"hash_7426f09e34fce5cb"), 40, #"hash_72928f658edc721d", 2, array("start_enter_complex_collision"), 1);
...
function function_45d34164(var_2970d97, var_9c8d914, var_af764233, var_f1111d99, var_7d599ca, var_d40d02dc) {
    ...
    while (1) {
        ...
        for (i = 0; i < var_f1111d99; i++) {
            ...
            level notify(#"stop_nag");
            level notify(#"hash_265967974cb19cdd");
            if (i == 0) {
        ...
        level.var_632734b1 = 2;
        level notify(#"hash_835dfb44a8f2df9");
...
function function_eb17793c() {
    ...
    level notify(#"hash_1bf3d1265168ccc9");
    level notify(#"hash_3a93dae9fd6a221d");
    level thread ct_vo::function_14b08e49(array(#"hash_1912c92a46f64dd7"), "stop_nag");
    var_3608d414 = array("vox_tvoi_tutor_noma_slide_10_1");
    ct_utils::function_93c86846(var_3608d414, "s_goto_enemy_tripwire_obj", array(#"ability_dog", #"eq_tripwire"), 0, undefined, 45);
    level notify(#"stop_nag");
    level notify(#"hash_154c156362e00843");
    ...
    while (1) {
        ...
        if (!(isdefined(b_vo_played) && b_vo_played)) {
            ...
            level notify(#"hash_5618c2195cf5dacf");
            b_vo_played = 1;
        }
        e_player = getplayers()[0];
...
function function_afa281f4() {
    level endon(#"combattraining_logic_finished");
    level notify(#"hash_2062ddd8e462b68");
    level notify(#"hash_61e89314b61c4775");
...
function function_244e4db8() {
    ...
    level notify(#"hash_397985772e68b1eb");
    level notify(#"hash_745d79d8a983f428");
    level notify(#"hash_5c77ffbfaa1ad08b");
    level notify(#"hash_3763f9b0a6176aff");
    level thread ct_vo::function_14b08e49(array(#"hash_1912c92a46f64dd7"), "stop_nag");
    ...
    level notify(#"hash_64d655eaba961026");
    ct_vo::function_3ca1b77d();
    ...
    level notify(#"hash_58ea19de3d30bc8e");
    e_player = getplayers()[0];
...
function function_ba6c3061() {
    level endon(#"combattraining_logic_finished");
    level waittill(#"hash_55f77db51abaf5f3");
...
function function_2e9a1486() {
    level endon(#"combattraining_logic_finished");
    ct_utils::function_e9ab1003(undefined);
    level notify(#"hash_2d98cce9cb0b2a34");
    level notify(#"hash_2dcd6cc5e35faa20");
    level thread ct_vo::function_14b08e49(array(#"hash_1912c92a46f64dd7"), "stop_nag");
    ct_utils::function_93c86846(undefined, "s_attack_dog_patrol_obj", undefined, 0, undefined, 50);
    level notify(#"stop_nag");
    level notify(#"hash_7cbb54c2c9022e42");
    level notify(#"hash_41a299dc974026c9");
    ...
    level notify(#"hash_37fa129aeec94ccc");
    level notify(#"hash_5338fd2ad1b5da29");
    level notify(#"hash_729d52c3deaa9d16");
...
function function_34696b67() {
    ...
    level notify(#"stop_nag");
    ct_utils::function_e9ab1003("s_defuse_bomb_obj");
    level notify(#"hash_6b3a7c4d7ab02d76");
    level notify(#"hash_20c0c460a6931a72");
    ...
    while (1) {
        ...
        if (b_timeout) {
            level notify(#"hash_7bd29fa0bf08552");
    ...
    ct_utils::function_9aca2fa0("ct_action");
    level notify(#"hash_7bd29fa0bf08552");
    level notify(#"hash_7cc96ce0987abca");
            ...
            while (1) {
                ...
                if (!isalive(e_player)) {
                    ...
                    if (isdefined(e_player.var_85988a58)) {
                        foreach (var_a173320f in e_player.var_85988a58) {
                            var_a173320f dodamage(var_a173320f.health + 100, var_a173320f.origin);
                        }
                    }
...
function function_ae12f07c(player) {
    ...
    level notify(#"hash_345d7e196e98876c");
}
...
// Size: 0x354
function function_432f35f8(var_8b97dd8f) {
    level endon(#"combattraining_logic_finished");
    level.var_e72728b8 = array(#"ability_dog");
    ...
    while (b_waiting) {
        if (isdefined(level.var_204eb642)) {
            ...
            n_height_diff = abs(level.var_204eb642.origin[2] - var_8b97dd8f.origin[2]);
            if (n_height_diff > 22) {
                var_8167b460 = 1;
            }
            n_dist = distance(level.var_204eb642.origin, var_8b97dd8f.origin);
            if (!var_8167b460 && n_dist < 75) {
                ...
                if (!ct_vo::function_5d127774()) {
                    var_3608d414 = array("vox_tvoi_tutor_noma_slide_4_miss");
...
function function_3b95089d(var_df7e07e5, var_7c876c46, var_2e663c1b) {
    self endon(#"death");
    self val::set(#"hash_4a0d94c78ad2f501", "ignoreall", 1);
...
function function_ccbcdbce() {
    level waittill(#"hash_835dfb44a8f2df9");
    var_3608d414 = array("vox_tvoi_tutor_noma_slide_4_0");
    level thread ct_vo::function_831e0584(var_3608d414, 1);
    level waittill(#"hash_835dfb44a8f2df9");
    var_3608d414 = array("vox_tvoi_tutor_noma_slide_5_0");
    level thread ct_vo::function_41e59aeb(var_3608d414, 1);
    level waittill(#"hash_835dfb44a8f2df9");
    var_3608d414 = array("vox_tvoi_tutor_noma_slide_6_0");
    level thread ct_vo::function_41e59aeb(var_3608d414, 1);
    level waittill(#"hash_835dfb44a8f2df9");
    wait(1);
    var_3608d414 = array("vox_tvoi_tutor_noma_slide_7_0");
    ct_vo::function_41e59aeb(var_3608d414, 1);
}
...
function function_f606c349() {
    level waittill(#"hash_835dfb44a8f2df9");
    var_3608d414 = array(#"hash_7c28af2622f285e4");
    ct_vo::function_831e0584(var_3608d414, 1);
    level waittill(#"hash_622db456eabd4e20");
    var_3608d414 = array("vox_tvoi_tutor_noma_slide_9_0");
    ct_vo::function_831e0584(var_3608d414, 1);
}
...
function function_4613d123() {
    ...
    level waittill(#"hash_265967974cb19cdd");
    level waittill(#"hash_265967974cb19cdd");
    level thread ct_vo::function_41e59aeb(array(#"hash_1a1b9b4d540e81ef"), 1);
    level waittill(#"hash_205740d9a7c3b4b8");
...
function function_eb021db8() {
    ...
    while (1) {
        waitresult = undefined;
        waitresult = level waittill(#"hash_5ffeb02b3dfcec40");
