...
#include scripts/wz_common/wz_jukebox.gsc;
...
#include script_7611295950bc2c87;
#include script_5f3e7d348fbc5283;
...
function event_handler[level_init] main(eventstruct) {
    ...
    if (isdefined(getgametypesetting(#"wzheavymetalheroes")) && getgametypesetting(#"wzheavymetalheroes")) {
        level.var_2089aa11 = #"hash_5754a06c21bb7ad3";
        namespace_3d2704b3::function_f0297225(#"hash_1e669a620270a631", 2, 4);
    }
    if (util::get_game_type() == "warzone_pandemic_quad") {
        namespace_3d2704b3::function_f0297225(#"hash_a2e61e4e076fb8d", 2147483647, 100);
    ...
    /#
        ...
        foreach (group in var_1d9375fc) {
            ...
            case #"open_skyscraper_vehicles_arav":
                var_d5d9cd1 = group;
                break;
            case #"hash_2cb3a37c908b9d9b":
                var_96bc77ce = group;
                break;
            case #"hash_139acdd590ca3442":
                var_208aaa54 = group;
                break;
            case #"hash_3b1a45effd27050":
                var_25dfca32 = group;
                break;
            case #"hash_6d90d15ce8e75ac2":
                var_4b606147 = group;
                break;
            case #"hash_18134e61b5fb4bd0":
                var_d6662d66 = group;
                break;
            case #"hash_10f8fa86764a95a2":
                var_dc1ea650 = group;
                break;
            case #"hash_18fb285aa313e821":
                var_707ce24b = group;
                break;
            case #"hash_32decf8f5b9557fa":
                var_e3ab2d7f = group;
                break;
            case #"hash_64604aee91f4fc0a":
                var_169219e9 = group;
                break;
            case #"hash_31be38307768aac2":
                var_4bf01581 = group;
                break;
            case #"hash_1fa35d6531b6441e":
                var_993b03f = group;
                break;
            case #"hash_159e4e48721d6125":
                var_5864ac74 = group;
                break;
            case #"hash_1926dc7c3ce2bfb2":
                var_25e0e288 = group;
                break;
            case #"hash_19b0005ca3a8c6c":
                var_284a1b99 = group;
                break;
            default:
                break;
...
function function_317da0a9(var_1d9375fc, group, point, var_9b62e326, var_cc2e4f94, n_z, n_dist) {
    /#
        ...
        v_angles = point.angles;
        var_c24ea284 = undefined;
        if (isdefined(group.var_b91441dd) && isdefined(group.var_b91441dd.vehiclespawner) && group.var_b91441dd.vehiclespawner) {
            return 1;
        }
        if (isdefined(group.var_b91441dd) && isdefined(group.var_b91441dd.supplystash) && group.var_b91441dd.supplystash) {
...
function function_2e72f24d(tracepoint, weapon) {
    /#
        ...
        while (1) {
            ...
            damage = var_60f853d9 * var_bf960c5;
            i++;
...
function function_a2b6e273() {
    /#
        /#
            ...
            if (!isdefined(level.var_94cbd997)) {
                return;
            }
            ...
            while (1) {
                if (player util::up_button_pressed()) {
                    ...
                    if (n_index == 0) {
                        n_index = level.var_94cbd997.size - 1;
                    } else {
                        n_index--;
                    }
                }
                if (n_index != var_d4714efb) {
                    player setorigin(level.var_94cbd997[n_index].origin);
                    player setplayerangles((0, level.var_94cbd997[n_index].angles[1], 0));
                    var_d4714efb = n_index;
                    wait(0.1);
                }
                if (player buttonpressed("<unknown string>")) {
                    spawn = level.var_94cbd997[n_index];
