...
function on_game_playing() {
    ...
    if (util::isfirstround()) {
        level scene::add_scene_func(#"hash_3b794c91ad2e5983", &function_33022f5b, "play");
        level thread scene::play(#"hash_3b794c91ad2e5983");
        level thread scene::play(#"hash_21150ad229258e74");
    }
}
...
function function_2cdcf5c3() {
    ...
    if (!util::isfirstround()) {
        level thread scene::skipto_end(#"hash_3b794c91ad2e5983");
        level thread scene::skipto_end(#"hash_21150ad229258e74");
    }
}
