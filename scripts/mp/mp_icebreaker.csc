...
#include scripts/mp/mp_icebreaker_scripted.csc;
#include scripts/mp/mp_icebreaker_water.csc;
#include scripts/mp/mp_icebreaker_sound.csc;
#include scripts/mp/mp_icebreaker_fx.csc;
