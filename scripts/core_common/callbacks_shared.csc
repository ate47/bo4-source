...
// Size: 0x134
function event<systemstatechange> codecallback_statechange(eventstruct) {
...
// Size: 0x5c
function event<maprestart> codecallback_maprestart(eventstruct) {
    /#
...
// Size: 0x54
function event<localclient_connect> codecallback_localclientconnect(eventstruct) {
    /#
...
// Size: 0x54
function event<sound_setambientstate> codecallback_soundsetambientstate(eventstruct) {
...
// Size: 0xc
function event<sound_setaiambientstate> codecallback_soundsetaiambientstate(eventstruct) {
...
// Size: 0x50
function event<event_10eed35b> function_d3771684(eventstruct) {
...
// Size: 0x34
function event<sound_playuidecodeloop> codecallback_soundplayuidecodeloop(eventstruct) {
...
// Size: 0x24
function event<player_spawned> codecallback_playerspawned(eventstruct) {
...
// Size: 0x54
function event<event_d6f9e6ad> function_c1d1f779(eventstruct) {
...
// Size: 0x34
function event<event_e469e10d> function_cfcbacb1(eventstruct) {
...
// Size: 0x50
function event<entity_gibevent> codecallback_gibevent(eventstruct) {
...
// Size: 0x2c
function event<gametype_precache> codecallback_precachegametype(eventstruct) {
    if (isdefined(level.var_d3dfbdd1)) {
        [[ level.var_d3dfbdd1 ]]();
    }
}
...
// Size: 0x24
function event<entity_spawned> codecallback_entityspawned(eventstruct) {
...
// Size: 0x92
function event<sound_notify> codecallback_soundnotify(eventstruct) {
...
// Size: 0x74
function event<entity_shutdown> codecallback_entityshutdown(eventstruct) {
...
// Size: 0x5c
function event<localclient_shutdown> codecallback_localclientshutdown(eventstruct) {
...
// Size: 0x26
function event<localclient_changed> codecallback_localclientchanged(eventstruct) {
    level.localplayers = getlocalplayers();
}
...
// Size: 0xc4
function event<player_airsupport> codecallback_airsupport(eventstruct) {
...
// Size: 0x76
function event<demosystem_jump> codecallback_demojump(eventstruct) {
...
// Size: 0x3e
function event<player_switch> codecallback_playerswitch(eventstruct) {
...
// Size: 0x9c
function event<killcam_begin> codecallback_killcambegin(eventstruct) {
...
// Size: 0x9c
function event<killcam_end> codecallback_killcamend(eventstruct) {
...
// Size: 0x40
function event<player_corpse> codecallback_creatingcorpse(eventstruct) {
...
// Size: 0xcc
function event<exploder_activate> codecallback_activateexploder(eventstruct) {
...
// Size: 0xcc
function event<exploder_deactivate> codecallback_deactivateexploder(eventstruct) {
    if (!isdefined(level._exploder_ids)) {
        return;
    }
    exploder = undefined;
...
// Size: 0x50
function event<sound_chargeshotweaponnotify> codecallback_chargeshotweaponsoundnotify(eventstruct) {
...
// Size: 0x54
function event<entity_footstep> codecallback_playaifootstep(eventstruct) {
...
// Size: 0x70
function event<extracam_currentheroheadshot> codecallback_extracamrendercurrentheroheadshot(eventstruct) {
...
// Size: 0x94
function event<event_3cbeb> function_327732bf(eventstruct) {
...
// Size: 0x70
function event<extracam_characterheaditem> codecallback_extracamrendercharacterheaditem(eventstruct) {
...
// Size: 0x64
function event<extracam_genderrender> codecallback_extracamrendergender(eventstruct) {
...
// Size: 0x88
function event<extracam_wcpaintjobicon> codecallback_extracamrenderwcpaintjobicon(eventstruct) {
...
// Size: 0x88
function event<extracam_wcvarianticon> codecallback_extracamrenderwcvarianticon(eventstruct) {
...
// Size: 0x4c
function event<collectibles_changed> codecallback_collectibleschanged(eventstruct) {
...
// Size: 0xc6
function event<notetrack_callclientscript> codecallback_callclientscript(eventstruct) {
...
// Size: 0xce
function event<notetrack_callclientscriptonlevel> codecallback_callclientscriptonlevel(eventstruct) {
    if (!isdefined(level._animnotifyfuncs)) {
        return;
    }
    if (isdefined(level._animnotifyfuncs[eventstruct.label])) {
...
// Size: 0x44
function event<scene_init> codecallback_serversceneinit(eventstruct) {
...
// Size: 0x5c
function event<scene_play> codecallback_serversceneplay(eventstruct) {
...
// Size: 0x6c
function event<scene_stop> codecallback_serverscenestop(eventstruct) {
    level thread scene_black_screen();
    if (isdefined(level.server_scenes[eventstruct.scene_name])) {
...
// Size: 0x4c
function event<gadget_visionpulsereveal> codecallback_gadgetvisionpulse_reveal(eventstruct) {
...
// Size: 0x4c
function event<event_1f757215> function_5067ee2f(eventstruct) {
...
// Size: 0x3c
function event<forcestreambundle> codecallback_forcestreambundle(eventstruct) {
...
// Size: 0x64
function event<event_bfc28859> function_582e112f(eventstruct) {
...
// Size: 0x34
function event<event_a5e70678> function_11988454(eventstruct) {
...
// Size: 0x7c
function event<trigger> codecallback_trigger(eventstruct) {
    if (isdefined(level.var_a6c75fcb)) {
...
// Size: 0x2c
function event<melee> codecallback_melee(eventstruct) {
...
// Size: 0x2c
function event<culled> function_667f84de(eventstruct) {
...
// Size: 0x6c
function event<weapon_change> function_6846a2b7(eventstruct) {
...
// Size: 0x6c
function event<event_41480c76> function_c33f3471(eventstruct) {
    if (self function_21c0fa55()) {
...
// Size: 0x2c
function event<event_6e84b1b1> function_ff9acfac(eventstruct) {
...
// Size: 0x7c
function event<event_eae361ae> function_a1ad9b51(eventstruct) {
    if (self function_21c0fa55()) {
...
// Size: 0x3c
function event<updateactivecamo> codecallback_updateactivecamo(eventstruct) {
...
// Size: 0x2c
function event<event_ab7a7fd3> function_bc70e1e4(eventstruct) {
