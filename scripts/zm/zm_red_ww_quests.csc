...
function init() {
    ...
    level._effect[#"hash_3c9256be63bb73ed"] = #"hash_1b1d42d579380f1b";
    level._effect[#"hash_70ef864effe35b13"] = #"hash_64892654f5d0133c";
...
function function_91aa103(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwasdemojump) {
    ...
    } else if (self.model === #"p8_zm_red_gauntlet_handle") {
...
function function_f8b29e52(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwasdemojump) {
    ...
    } else if (isdefined(self.var_abef553)) {
...
function function_e887425a(localclientnum) {
    ...
    if (!self postfx::function_556665f2(#"hash_15eff8e17bf3cb64")) {
        self postfx::playpostfxbundle(#"hash_15eff8e17bf3cb64");
    }
...
function function_761eecad(localclientnum) {
    if (self postfx::function_556665f2(#"hash_15eff8e17bf3cb64")) {
        self postfx::exitpostfxbundle(#"hash_15eff8e17bf3cb64");
    }
    if (isdefined(self.var_222e996f)) {
...
function function_a3c7c7fa(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwasdemojump) {
    if (newval) {
        ...
        wait(0.5);
        if (isdefined(self)) {
            self.var_8eb4e749 = playfx(localclientnum, level._effect[#"hash_501b5bcc2ef34bb5"], self.origin + vectorscale((0, 0, 1), 45) + anglestoforward(self.angles) * -6, anglestoforward(self.angles), anglestoup(self.angles));
            self playrenderoverridebundle("rob_zm_gaia_portal_dissolve");
        }
    } else {
        if (isdefined(self.var_8eb4e749)) {
...
function function_251065bc(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwasdemojump) {
    ...
    } else if (isdefined(self.var_f9359f98)) {
