...
#include script_a0dec417269b39e;
#include script_7893277eec698972;
#include scripts/zm/zm_zodt8_tutorial.gsc;
#include script_311952573639271c;
#include scripts/zm/zm_zodt8_sentinel_trial.gsc;
#include scripts/zm/zm_zodt8_pap_quest.gsc;
#include script_a0ad3ffb578dfd1;
#include scripts/zm/zm_zodt8_eye.gsc;
#include scripts/zm/zm_zodt8_achievements.gsc;
#include scripts/zm/zm_zodt8_sound.gsc;
#include scripts/zm/powerup/zm_powerup_free_perk.gsc;
...
#include scripts/zm/ai/zm_ai_stoker.gsc;
#include scripts/zm/zm_zodt8_devgui.gsc;
#include script_15033c9cfcaa4981;
...
#include scripts/zm/weapons/zm_weap_bowie.gsc;
...
#include scripts/zm_common/zm_audio_sq.gsc;
...
function private function_8ceb4377() {
    ...
    #/
    if (level.var_d77a6967.name == #"hash_1ef6d4689b73b1ce") {
...
function private function_4d4e4de() {
    ...
    if (level.players.size == 1) {
        var_ddf9ad37 = zombie_utility::function_d2dfacfd(#"hash_376905ad360fc2e8");
        var_424eb3ee = randomintrange(zombie_utility::function_d2dfacfd(#"hash_2374f3ef775ac2c3"), zombie_utility::function_d2dfacfd(#"hash_2374f3ef775ac2c3") + 2);
    } else {
        var_ddf9ad37 = zombie_utility::function_d2dfacfd(#"hash_6eb9b2d60babd5aa");
        var_424eb3ee = randomintrange(zombie_utility::function_d2dfacfd(#"hash_3b4ad7449c039d1b"), zombie_utility::function_d2dfacfd(#"hash_3b4ad7449c039d1b") + 2);
    }
            ...
            if (zombie_utility::function_d2dfacfd(#"zombie_powerup_fire_sale_on")) {
                ...
                foreach (s_magic_box in level.chests) {
                    if (!(isdefined(s_magic_box.hidden) && s_magic_box.hidden) && isdefined(s_magic_box.script_noteworthy)) {
                        ...
                        case #"hash_721c9da9f5f1897e":
                            var_f8c33269 showpart("j_promenade");
                            break;
                        case #"hash_2769ecde8193298d":
                            var_f8c33269 showpart("j_cargo");
                            break;
                        ...
                        case #"hash_6bc21bb77ccc429b":
                            var_f8c33269 showpart("j_grand_stair_lower");
                            break;
                        case #"hash_1dd34184f8fe98cd":
                            var_f8c33269 showpart("j_lounge");
                            break;
                        case #"hash_23cfa652ecaa206e":
                            var_f8c33269 showpart("j_grand_stair_upper");
                            break;
                        case #"hash_5dbba6e3bdcb722e":
                            var_f8c33269 showpart("j_bridge");
                            break;
...
function function_ed8a8823() {
    do {
        ...
        b_played = t_trigger.who zm_audio::create_and_play_dialog(#"sentinel", #"hash_10bb06209b475854");
        waitframe(1);
...
function function_ea9f953(var_fad7ef6a = 1, var_3e58f0ee = 1) {
    if (var_fad7ef6a) {
        ...
        var_52a797c0 scene::play(#"hash_52a233fde15c892d", "end");
    ...
    if (var_3e58f0ee) {
        ...
        var_a3423419 scene::play(#"hash_52a233fde15c892d", "end");
...
function function_1d8df872(b_on) {
    ...
    if (b_on) {
        self scene::play(#"hash_52a233fde15c892d", "start");
        self scene::play(#"hash_52a233fde15c892d", "on");
    } else {
        self scene::play(#"hash_52a233fde15c892d", "end");
    }
}
...
function function_4b17dd44(a_ents) {
    ...
    if (isdefined(a_ents[#"hash_57539ad4839010e"])) {
        a_ents[#"hash_57539ad4839010e"] delete();
    }
    if (isdefined(a_ents[#"hash_4f8fa35f9f580d97"])) {
        a_ents[#"hash_4f8fa35f9f580d97"] delete();
    }
}
...
function function_17ac86f7() {
    self thread zm_audio::function_713192b1(#"hash_23a9baa5b7fb1b8", #"hash_377c6c5455470417");
    self thread zm_audio::function_713192b1(#"hash_3325f6b80c910400", #"hash_e64d20be9642b73");
    self thread zm_audio::function_713192b1(#"hash_1f322078edfcfba3", #"hash_4ca3fbc20a0c14db");
    self thread zm_audio::function_713192b1(#"hash_118b4d5763e21783", #"hash_3d81e85239f23e3c");
    self thread zm_audio::function_713192b1(#"hash_35000bfda3024a1f", #"hash_ab56ee25d89a2de");
