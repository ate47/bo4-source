...
#include scripts/zm/zm_towers_trials.gsc;
#include script_6334bf874cddcc13;
#include scripts/zm/zm_towers_zones.gsc;
#include scripts/zm/zm_towers_ww_quest.gsc;
#include scripts/zm/zm_towers_util.gsc;
#include scripts/zm/zm_towers_special_rounds.gsc;
#include script_1781ac145d783f87;
#include scripts/zm/zm_towers_shield.gsc;
#include script_5e036f43dab5ec66;
#include scripts/zm/zm_towers_pap_quest.gsc;
#include scripts/zm/zm_towers_narrative.gsc;
#include scripts/zm/zm_towers_main_quest.gsc;
#include scripts/zm/zm_towers_challenges.gsc;
#include scripts/zm/zm_towers_crowd.gsc;
#include scripts/zm/zm_towers_achievements.gsc;
#include script_2affe92664ace48d;
#include script_684097158a90b5c3;
#include scripts/zm/ai/zm_ai_elephant.gsc;
#include scripts/zm/zm_towers_gamemodes.gsc;
...
function function_63a4a57a() {
    ...
    while (1) {
        ...
        foreach (ai_zombie in getaiarray()) {
            ...
            } else if (isdefined(ai_zombie.var_4935908f) && ai_zombie.var_4935908f) {
