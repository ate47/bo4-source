...
#include scripts/zm/zm_red_gamemodes.gsc;
#include scripts/zm/zm_red_trials.gsc;
#include scripts/zm/zm_red_ffotd.gsc;
#include scripts/zm/zm_red_main_quest.gsc;
...
#include scripts/zm/zm_red_trap_boiling_bath.gsc;
#include scripts/zm/zm_red_special_rounds.gsc;
#include scripts/zm/zm_red_pap_quest.gsc;
#include scripts/zm/zm_red_fasttravel.gsc;
#include scripts/zm/zm_red_power_quest.gsc;
#include scripts/zm/zm_red_oracle_boons.gsc;
...
#include scripts/zm/zm_red_achievement.gsc;
...
#include scripts/zm/weapons/zm_weap_thunderstorm.gsc;
