...
#include scripts/zm/zm_red_oracle_boons.csc;
#include scripts/zm/zm_red_main_quest.csc;
#include scripts/zm/zm_red_ww_quests.csc;
#include scripts/zm/zm_red_util.csc;
#include script_41a75e0d79b62736;
#include scripts/zm/zm_red_trap_boiling_bath.csc;
#include scripts/zm/zm_red_power_quest.csc;
#include scripts/zm/zm_red_pap_quest.csc;
#include scripts/zm/zm_red_fasttravel.csc;
#include scripts/zm/zm_red_challenges.csc;
#include scripts/zm/zm_red_boss_battle.csc;
#include scripts/zm/ai/zm_ai_gegenees.csc;
#include scripts/zm/weapons/zm_weap_hand_charon.csc;
#include scripts/zm/weapons/zm_weap_hand_hemera.csc;
#include scripts/zm/weapons/zm_weap_hand_gaia.csc;
#include scripts/zm/weapons/zm_weap_hand_ouranos.csc;
#include scripts/zm/weapons/zm_weap_thunderstorm.csc;
