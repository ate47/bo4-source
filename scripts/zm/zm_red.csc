...
#using scripts\zm\zm_red_power_quest.csc;
#using scripts\zm\zm_red_pap_quest.csc;
#using scripts\zm\zm_red_fasttravel.csc;
#using scripts\zm\zm_red_challenges.csc;
#using scripts\zm\zm_red_boss_battle.csc;
...
#using scripts\zm\weapons\zm_weap_hand_ouranos.csc;
#using scripts\zm\weapons\zm_weap_thunderstorm.csc;
