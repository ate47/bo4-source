...
#include scripts/zm/weapons/zm_weap_hand_hemera.gsc;
#include scripts/zm/weapons/zm_weap_hand_charon.gsc;
#include scripts/zm/weapons/zm_weap_hand_ouranos.gsc;
#include scripts/zm/perk/zm_perk_mod_additionalprimaryweapon.gsc;
#include scripts/zm/perk/zm_perk_mod_quick_revive.gsc;
#include script_8dca41f2d7c91bc;
...
function function_7e94450c() {
    ...
    t_damage delete();
    self notify(#"hash_6858bc0ef6a5b4b1", {#var_2db8b01a:e_brick.scene_ents[#"prop 1"], #e_player:e_player});
}
...
function function_5e0885f9() {
    ...
    waitframe(1);
    self notify(#"hash_6858bc0ef6a5b4b1", {#var_2db8b01a:self, #e_player:s_notify.attacker});
}
...
function function_c573751a(e_player) {
    ...
    if (zm_utility::is_player_valid(e_player, 0, 0) && !var_ba96a60e && !var_ad6f56cb && !isdefined(var_b37a7d1e) && var_2d61b4e1) {
        ...
        return 1;
    } else if (zm_utility::is_player_valid(e_player, 0, 0) && (var_ba96a60e && var_2d61b4e1 || isdefined(var_b37a7d1e)) && !var_ad6f56cb) {
...
function function_9aa785fe(e_player) {
    ...
    while (1) {
        ...
        if (s_waitresult.e_who === e_player && w_hand === self.var_884c4b3a && !e_player flag::get(#"hash_8cdde8e6a8607f1") && w_hand != level.var_3eccc872) {
        ...
        if (isdefined(e_player.a_b_coins)) {
            for (i = 0; i < 3; i++) {
                if (isdefined(e_player.a_b_coins[i]) && e_player.a_b_coins[i]) {
                    ...
                    var_c32d5cdf = util::spawn_model(#"p8_zm_red_charron_coin_01_emissive", self.var_d091995a[i].origin, self.var_d091995a[i].angles);
...
function function_adc2d252(e_player) {
    ...
    if (zm_utility::is_player_valid(e_player, 0, 0) && s_quest flag::get("river_styx_filled") && !e_player flag::get(#"hash_8cdde8e6a8607f1") && var_b37a7d1e === getweapon(#"ww_hand_c_uncharged")) {
        ...
        self sethintstringforplayer(e_player, str_prompt);
        return 1;
    } else if (isdefined(self.var_4d532f57) && self.var_4d532f57) {
        self sethintstringforplayer(e_player, "");
        return 0;
    } else {
        self sethintstringforplayer(e_player, "");
...
function function_60f650e3() {
    ...
    foreach (var_542837e6 in var_d445485f) {
        ...
        zm_weap_hand_hemera::function_25513188(var_919d328);
    }
...
function function_6d466962(var_8290a028, s_original, mdl_feather, e_player = undefined) {
    ...
    var_8290a028 thread scene::play(#"hash_3305bad57b82b3bc", "feather01_float", mdl_feather);
    ...
    if (!isdefined(var_40bb500f.target)) {
        ...
        var_8290a028 thread scene::play(#"hash_3305bad57b82b3bc", "feather01_fall", mdl_feather);
        var_8290a028 waittill(#"movedone");
        if (isdefined(e_player)) {
...
function function_759736f(var_8290a028, mdl_feather) {
    var_8290a028 thread scene::play(#"hash_3305bad57b82b3bc", "feather01_gust", mdl_feather);
    var_40bb500f = struct::get(self.target, "targetname");
...
function function_73c422de(e_player) {
    if (zm_utility::is_player_valid(e_player, 0, 0) && self.stub.related_parent flag::get("seedling_available") && e_player function_996fee51() === getweapon(#"ww_hand_g_uncharged") && e_player getcurrentweapon() != level.var_3eccc872 && e_player getstance() != "prone") {
...
function function_3f05435f() {
    if (isalive(self)) {
        self notify(#"risen");
        level notify(#"transformation_complete", {#var_944250d2:array(self)});
...
function function_e3a8b066(var_fc6baa64) {
    /#
        ...
        if (isdefined(level.var_f9a57be7[level.var_65569374].t_damage)) {
            level.var_f9a57be7[level.var_65569374].t_damage notify(#"damage", {#mod:"zone_ww_quest_air", #attacker:a_players[0]});
        } else {
...
function function_681ce100() {
    /#
        ...
        foreach (var_52666e80 in var_1d89b97b) {
            var_f927d3b3 = getent(var_52666e80.script_noteworthy, "break");
            var_26450f62 = getentarray(var_f927d3b3.target, "break");
            a_players[0] setorigin(var_52666e80.origin);
            a_players[0] setplayerangles(var_52666e80.angles);
            foreach (var_feb69dca in var_26450f62) {
                switch (var_feb69dca.model) {
                case #"hash_17ff8b184015c0d0":
                    v_tag_pos = var_feb69dca gettagorigin("<unknown string>");
                    break;
                case #"hash_17ff8e184015c5e9":
                    v_tag_pos = var_feb69dca gettagorigin("<unknown string>");
                    break;
                ...
                level notify(#"ww_gaia_hit", {#v_position:v_tag_pos, #e_entity:var_feb69dca, #player:a_players[0]});
                wait(0.25);
            }
        }
        wait(4.5);
...
function function_d6e30032() {
    /#
        ...
        foreach (var_542837e6 in var_d445485f) {
            var_919d328 = getent(var_542837e6.target, "break");
