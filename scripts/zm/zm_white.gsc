...
#include scripts/zm/zm_white_devgui.gsc;
#include scripts/zm/zm_white_trials.gsc;
#include scripts/zm/zm_white_trophies.gsc;
...
#include scripts/zm/zm_white_ww_quest_modkit.gsc;
#include script_724752ab26bff81b;
#include scripts/zm/zm_white_lighting.gsc;
#include scripts/zm/zm_white_special_rounds.gsc;
#include scripts/zm/zm_white_mee.gsc;
#include scripts/zm/zm_white_fx.gsc;
#include scripts/zm/zm_white_portals.gsc;
#include scripts/zm/zm_white_toast.gsc;
#include script_621434df66e97145;
#include script_1c1d447ddbce2c00;
#include script_25b8e6a85a7f8635;
#include scripts/zm/zm_white_insanity_mode.gsc;
#include script_48dd035d23bf8844;
#include scripts/zm/zm_white_doomsday_clock.gsc;
#include script_78e9e286015f2ec;
#include script_2da1a66a13e2bbe1;
#include script_2f877a0752174fc1;
#include scripts/zm/zm_white_zones.gsc;
#include scripts/zm/zm_white_util.gsc;
#include scripts/zm/zm_white_zstandard.gsc;
#include scripts/zm/zm_white_gamemodes.gsc;
...
function function_7e6cf034() {
    ...
    case 2:
        ...
        jumpiffalse(zm_custom::function_901b751c(#"zmpowerdoorstate") == 1) LOC_00000326;
        zm_white_util::function_ca4ee4d1("bunker_door");
        zm_white_util::function_f4a39bc4();
        zm_white_util::function_bf25aeb1("bunker_door_electric");
        var_c39fcc2 = getentarray("lockdown_trigger", "targetname");
