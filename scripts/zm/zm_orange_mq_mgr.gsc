...
#include scripts/zm/zm_orange_lights.gsc;
#include script_4ec1d631174f7283;
...
#include scripts/zm/zm_orange_mq_campfire.gsc;
#include scripts/zm/zm_orange_mq_blood.gsc;
#include scripts/zm/zm_orange_mq_vessel.gsc;
#include scripts/zm/zm_orange_mq_dials.gsc;
