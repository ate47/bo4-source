...
function function_52498131(var_edb0b1c5 = 5) {
    level notify(#"hash_749e72f23b017c8f");
...
function function_84139b27() {
    ...
    zm_utility::function_c492c4d6(#"lounge", #"hash_18944a1360325a74", array(#"hash_7c42c70d1b75af3a"), array(#"engine_room", #"hash_5611ac0b89e7f8b1", #"cargo_hold", #"bridge"), #"hash_40ba277929e49516", #"hash_2bed1c6d7afa4192");
...
function function_1dcc39ae() {
    /#
        wait(5);
        var_f79ff5ec = zm_utility::function_40ef77ab("<unknown string>");
        var_679cd7a8 = zm_utility::function_a877cd10(var_f79ff5ec);
        zm_utility::enable_power_switch(1, 1);
        while (1) {
            zm_utility::function_11101458(var_f79ff5ec);
