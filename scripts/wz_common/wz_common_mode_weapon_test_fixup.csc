...
// Params 0, eflags: 0x2
// Checksum 0x4de8e91b, Offset: 0x140
// Size: 0x14
...
// Namespace wz_common_mode_weapon_test_fixup/wz_common_mode_weapon_test_fixup
// Params 0
// Checksum 0xbac78210, Offset: 0x160
// Size: 0x6c4
function function_e420bad2()
{
    ...
    if ( isdefined( getgametypesetting( #"wzweaponstest" ) ) && getgametypesetting( #"wzweaponstest" ) )
    {
        ...
        wz_common_fixup::item_replacer( var_f8a4c541, undefined, #"supply_stash_weapons", str_list + "_guns_gold" );
